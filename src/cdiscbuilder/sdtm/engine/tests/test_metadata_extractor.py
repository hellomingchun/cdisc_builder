...
def test_extract_metadata_summary_empty():
    ...
    assert list(df_none.columns) == ['FormOID', 'ItemGroupOID', 'ItemOID', 'ItemName', 'Question', 'SampleValues']
...
def test_extract_metadata_summary_valid():
    ...
    assert list(meta_df.columns) == ['FormOID', 'ItemGroupOID', 'ItemOID', 'ItemName', 'Question', 'SampleValues']
