...
This notebook demonstrates how to use the `cdisc_builder` package to convert CDISC ODM XML data into SDTM domain datasets.
...
import pandas as pd
import os
from cdisc_builder.odm import parse_odm_to_long_df
