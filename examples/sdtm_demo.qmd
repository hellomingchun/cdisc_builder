...
# Paths
xml_path = "../car-t-openclinica.xml"  # Adjust path as needed
...
We have created a folder named `sdtm/specs` containing `DM.yaml` and `AE.yaml`.

```{python}
import os

# Define config directory
config_dir = "sdtm/specs"
...
# Load Generated AE
ae_path = os.path.join(output_dir, "AE.parquet")
if os.path.exists(ae_path):
    df_ae = pd.read_parquet(ae_path)
    print("\n--- Generated AE Dataset ---")
    print(df_ae.head())
    
    # Verify Columns
    print(f"AE Columns: {df_ae.columns.tolist()}")
else:
    print("AE.parquet not found.")
```
